...
contract JointSavings {
    ...
    */
    function setAccounts(address payable account1, address payable account2) public{
        ...
        // Checks to make sure you own the account before you are able to change the account because otherwise...that would be insane.
        if (accountOne != address(0) && accountTwo != address(0)) {
    ...
    */
    function () external payable {
        // If money gets sent to this contract, ensure it is reflected in the contract
        contractBalance = address(this).balance;
    }
}
